...
export default class TotalAppl_2 extends Component{
    render(){
            ...
            <div className="relative p-6 border-2 shadow-md border-slate-800 rounded-md w-96 ">
                <div className="flex">
                    <div className="space-y-2">
                        ...
                        <p className="font-semibold text-white text-3xl">1501</p>
                        <div className="space-x-0.5 flex">
                            <img src="/arrow-red.png/" className="h-3 w-3 mt-1 rotate-90 transform" />
                            <p className="font-semibold text-rose-500 text-sm">-3.59%</p>
                        </div>
                    </div>
